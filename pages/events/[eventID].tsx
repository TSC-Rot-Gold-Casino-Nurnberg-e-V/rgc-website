...
export default function EventID({
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Navbar />
      <main className="m-auto max-w-3xl py-8 grow">
        ...
        <div className="prose m-auto">
          <div
            className="prose prose-p:text-justify prose-tr:flex prose-tr:justify-between prose-h2:text-center prose-table:my-4 prose-p:my-2 prose-a:text-red-900 prose-h3:text-red-900"
