...
export default function CourseID({
  ...
  return (
    <main className="m-auto max-w-3xl grow py-4 max-lg:px-6">
      ...
      <h2 className="my-2 text-2xl font-bold max-md:text-center">Trainer</h2>
      <div className="flex max-w-prose flex-wrap justify-between gap-10 max-md:flex-col max-md:items-center">
