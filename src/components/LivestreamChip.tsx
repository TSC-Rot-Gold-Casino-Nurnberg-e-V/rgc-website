...
export const LiveStreamChip = () => {
  ...
  return SHOW_LIVESTREAM && !isLivestreamPage ? (
    <Link
      href="/livestream"
      className="mx-auto grid w-fit -translate-y-1/2 grid-cols-[auto_1fr_auto] items-center rounded-full bg-base-800 transition-all hover:scale-105 hover:bg-base-700"
    >
